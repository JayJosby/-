...
file = dir + '\\res_900.txt'
fileW2V = dir + '\\resW2V_900.txt'
fileM = dir + '\\resM_900.txt'

newmarkfile = dir + '\\mark_900.txt'
...
def initDict(wordnum):
    ...
    f_Mmodel = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\Mmodel900.txt', 'r', encoding='utf-8')
    ...
    #存储匹配ws353规模的dict数据
    isDir('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\'+dataset+'\\'+dir)
