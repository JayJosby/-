...
def initDict(wordnum):
    ...
    f_Mmodel = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\Mmodel20000.txt', 'r', encoding='utf-8')
    ...
    #存储匹配ws353规模的dict数据
    isDir('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\'+dataset)
    f_dict = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\'+dataset + file, 'w+',encoding ='utf-8')
    f_dictW2V = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\'+dataset + fileW2V, 'w+',encoding ='utf-8')
    f_dictM = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\'+dataset + fileM, 'w+',encoding ='utf-8')
...
def getCorrcoef():
    f_dict = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\' + dataset + file, 'r',
                  encoding='utf-8')
    f_dictW2V = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\' + dataset + fileW2V, 'r',
                     encoding='utf-8')
    f_dictM = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\' + dataset + fileM, 'r',
                   encoding='utf-8')
    ...
    f = open('C:\\Users\Administrator\Desktop\论文\任务记录\词相似度\英文\第三次实验\\'+ dataset + newmarkfile, 'w+', encoding='utf-8')
